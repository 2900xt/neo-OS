...
namespace pci
{
    ...
    void enumerate_function(uint64_t device_addr, uint64_t function)
    {
        ...
        if (pci_func->device_id == 0 || pci_func->device_id == 0xFFFF)
    ...
    void enumerate_device(uint64_t bus_address, uint64_t device)
    {
        ...
        if (pci_dev->device_id == 0 || pci_dev->device_id == 0xFFFF)
    ...
    void enumerate_pci(void)
    {
        ...
        pci_devices = (device_t **)kernel::kcalloc(1, sizeof(device_t *) * 128);
